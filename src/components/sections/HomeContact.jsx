      ...
      >
        ...
        <div className="flex flex-col items-start gap-6 md:flex-row md:items-center md:justify-between">
          ...
          <motion.a
            ...
            whileTap={{ scale: 0.98 }}
            className="corner-glow group flex shrink-0 items-center gap-4 rounded-2xl border border-border bg-white px-6 py-5 shadow-[0_20px_45px_-24px_rgba(47,95,224,0.35)] transition-shadow duration-300 hover:shadow-glow"
          >
            ...
            <span className="flex flex-col">
              ...
              <span className="text-sm font-semibold text-ink">rgtvertex.ai@outlook.com</span>
            </span>
            <ArrowUpRight
              size={16}
              className="ml-2 text-ink-faint transition-all duration-200 group-hover:translate-x-0.5 group-hover:-translate-y-0.5 group-hover:text-accent"
            />
          </motion.a>
        </div>
      </motion.div>
